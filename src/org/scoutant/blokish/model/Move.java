...
public class Move implements Comparable<Move> {
	...
	public String toString() {
		return "" + piece.color + ":" + piece.type + ":" + i + ":" + j + ":"
				+ score;
	}
	...
	/**
	 * @return a represention of the piece, like this sample :
	 *         18:16:2:I3:0,-1:0,0:0,1
	 */
	public static String serialize(Move move) {
		return String.format("%s:%s:%s", move.i, move.j,
				Piece.serialize(move.piece));
	}
}